...
public enum SoundType implements ParrotSoundType {
    ...
    WARNING_BEEP("warning_beep", SoundCategory.WORLD, 1, 0.8f, 0.5f, 0.00f, PlaybackMode.ETERNAL, 0.0f),
    ...
    UI_CLICK("ui_hover", SoundCategory.USER_INTERFACE, 2, 0.65f, 1.5f, 0.0f, PlaybackMode.NORMAL, 0.0f),
