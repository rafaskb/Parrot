...
public enum SoundType implements ParrotSoundType {
    FOOTSTEPS("footsteps", SoundCategory.PLAYER, 3, 1.0f, 0.1f, 1.0f, 0.05f, PlaybackMode.NORMAL, 0.0f),
    WARNING_BEEP("warning_beep", SoundCategory.WORLD, 1, 0.8f, 0, 0.5f, 0.00f, PlaybackMode.ETERNAL, 0.0f),
    FLAMETHROWER_SPARK("flamethrower_spark", SoundCategory.PLAYER, 2, 1f, 0, 1.0f, 0.20f, PlaybackMode.NORMAL, 0.0f),
    FLAMETHROWER("flamethrower", SoundCategory.PLAYER, 1, 0.6f, 0, 1.0f, 0.00f, PlaybackMode.CONTINUOUS, 0.3f),
    UI_CLICK("ui_hover", SoundCategory.USER_INTERFACE, 2, 0.50f, 0, 1.5f, 0.0f, PlaybackMode.NORMAL, 0.0f),
    UI_HOVER("ui_hover", SoundCategory.USER_INTERFACE, 2, 0.35f, 0.2f, 1.0f, 0.03f, PlaybackMode.NORMAL, 0.0f);
    ...
    SoundType(String filename, SoundCategory category, int voices, float volume, float volumeVariation, float pitch, float pitchVariation, PlaybackMode playbackMode, float continuityFactor) {
